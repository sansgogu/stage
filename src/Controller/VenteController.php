...
final class VenteController extends AbstractController
{
    ...
    public function index(VenteRepository $venteRepository , ProduitRepository $produitsRepository , ClientProRepository  $clientsProRepository) : Response
    {
        return $this->render('vente/index.html.twig', [
            'ventes' => $venteRepository->findAll(),
            'produits' => $produitsRepository->findAll(),
            'clients' => $clientsProRepository->findAll(),
